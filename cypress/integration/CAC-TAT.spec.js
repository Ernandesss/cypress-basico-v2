...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it('preenche os campos obrigatórios e envia o formulário', function(){
        ...
        cy.get('#firstName').type('Ernandes')
        cy.get('#lastName').type('Vitor')
        cy.get('#email').type('ernandes.vitor@gmail.com')
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
        cy.get('#firstName')
            ...
            .should('have.value', "")
            cy.get('#email')
            .type('ernandes.vitor@gmail.com')
            .should('have.value', 'ernandes.vitor@gmail.com')
            .clear()
            .should('have.value', "")
            cy.get('#phone')
            .type('1959253846')
            .should('have.value', '1959253846')
            .clear()
            .should('have.value', "")
    })
